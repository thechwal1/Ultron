...
/**
 * The single entry point Ultron's voice pipeline calls. Order of checks,
 * fastest/most specific first — everything above the AI call is instant
...
class BrainRouter(
    ...
    // Lazy-init presence detector so a null appController doesn't crash construction
